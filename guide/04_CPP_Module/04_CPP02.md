...
From now on, all your classes must be designed in the Orthodox Canonical Form, unless explicitely stated otherwise. Then, they will implement the four required member
...
Please read this 3 pages article to discover that you don’t. Go on, read it.

- [Understanding and Using Floating Point Numbers by Jeff Bezanson](https://www.cprogramming.com/tutorial/floating_point/understanding_floating_point.html)
